...
interface AlertProps {
    type: 'error' | 'success'; // Define the type of alert
    message: string;
    onClose: () => void
}
...
const Alert: React.FC<AlertProps> = ({ type, message, onClose }) => {
    ...
    let classes = "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative w-full";
    if (type === "success") {
    ...
    return (
        <div className={classes} role="alert">
            <strong className="font-bold">{type === 'error' && 'Error: '}</strong>
